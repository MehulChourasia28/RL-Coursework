...
def run_eval(path_a, path_b, n=20, n_sims=400):
    ...
    while active:
        ...
        for net_id, (net, group) in groups.items():
            ...
            chosen = _batched_mcts(g_list, r_list, net, n_sims)
